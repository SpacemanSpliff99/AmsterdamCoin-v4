...
{
public:
    /// Is the inputs associated with this public key? (and there is 5000 PUFFS - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of puffscoin.
