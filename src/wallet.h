...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 PUFFS at the same time
...
public:
    ...
    /// Get 5000 PUFFS output and keys which can be used for the Masternode
