...
In order to support loading of multiple wallets in puffscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is puffscoin.cpp.
...
Changes to puffscoin.cpp
----------------------
puffscoin.cpp is the entry point into puffscoin-qt, and as such, will require some minor modifications to provide hooks for
