...
This mechanism has been integrated into Bitcore-Node-PUFFS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SpacemanSpliff99/insight-api-puffs#web-socket-api](https://github.com/SpacemanSpliff99/insight-api-puffs#web-socket-api) 
* API: [https://github.com/SpacemanSpliff99/insight-api-puffs#swifttx-transactions](https://github.com/SpacemanSpliff99/insight-api-puffs#swifttx-transactions) 
...
By default, the PUFFS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PUFFS Core daemon:
