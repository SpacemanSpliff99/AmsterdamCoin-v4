PuffsCoin Core version 2.2.1 is now available from:

  <https://github.com/puffscoin-project/puffscoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/puffscoin-project/puffscoin/issues>

Compatibility
==============

PuffsCoin Core is extensively tested on multiple operating systems using
...
PuffsCoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that PuffsCoin was forked from.
