...
* Update translations see [translation_process.md](https://github.com//SpacemanSpliff99/PUFFSco./blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign PuffsCoin Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit puffscoin=v${VERSION} ../puffscoin/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [puffscoin-detached-sigs](https://github.com/SpacemanSpliff99/puffscoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/SpacemanSpliff99/PUFFSco./releases/new) with a link to the archived release notes.
