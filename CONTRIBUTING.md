Contributing to AmsterdamCoin Core
============================

The PuffsCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PuffsCoin Core project, and is not to be
confused with overall PuffsCoin Network Protocol consensus changes.

Whether a pull request is merged into PuffsCoin Core rests with the project merge
...
Patches that change PuffsCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the PuffsCoin consensus, it must have been
...
The project leader is the release manager for each PuffsCoin Core release.
